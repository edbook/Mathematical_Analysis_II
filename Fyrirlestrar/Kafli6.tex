...
\subsubsection{Setning \rtask{} (Sundurleitnisetning I)}\stepcounter{mycount}
...
\subsubsection{Setning  \rtask{} (Setning Stokes I)}\stepcounter{mycount}
  Látum $\Fv$ vera samfellt
diffranlegt vigursvið skilgreint á opnu mengi $D$ í $\R^3$.    Látum
...
\subsubsection{Túlkun \rtask{}}\stepcounter{mycount}
...
\subsubsection{Setning Green \rtask{}}\stepcounter{mycount}
...
\subsubsection{Fylgisetning \rtask{}}\stepcounter{mycount}
 Látum $R$ vera svæði í planinu þannig að
jaðar $R$ táknaður með $\cal C$, 
samanstendur af endanlega mörgum samfellt diffranlegum
...
\subsubsection{Sundurleitnisetningin í tveimur víddum \rtask{}}\stepcounter{mycount}
