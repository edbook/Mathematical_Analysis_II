...
.. math:: \{(x,y,f(x,y))\mid (x,y)\in{\mathbb  R}^2\}\subseteq {\mathbb  R}^3.

Ef :math:`f:{\mathbb  R}^3\rightarrow {\mathbb  R}` er fall, þá er
*graf* fallsins skilgreint sem mengið

.. math:: \{(x,y,z,f(x,y,z))\mid (x,y,z)\in{\mathbb  R}^3\}\subseteq {\mathbb  R}^4.
...
.. math:: \{(x,y)\mid f(x,y)=c\}\subseteq {\mathbb  R}^2
...
.. math:: |\mbox{${\bf x}$}-\mbox{${\bf y}$}|=\sqrt{(x_1-y_1)^2+(x_2-y_2)^2+\cdots+(x_n-y_n)^2}.
...
.. math:: B_r(P)=\{Q\in\mbox{${\bf R}^n$}\mid |Q-P|<r\}.
...
Skilgreining 4. (Skilgreining 4.8 sett fram fyrir föll af tveimur breytum.) 
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. math:: f_1(a,b,c)=\lim_{h\rightarrow 0}\frac{f(a+h,b,c)-f(a,b,c)}{h},
...
.. math:: f_k(\mathbf{a})=\lim_{h\rightarrow 0}\frac{f(\mathbf{a}+h\mbox{${\bf e}$}_k)-f(\mathbf{a})}{h}
...
.. math:: (a,b,f(a,b))+s\mbox{${\bf T}$}_1+t\mbox{${\bf T}$}_2, \quad -\infty < s,t < \infty.
...
.. math:: (a,b,f(a,b)) + u \mbox{${\bf n}$}, \quad -\infty < u < \infty.
...
.. math:: f_{12}(a,b)=f_{21}(a,b).

Hugmynd að skilgreiningu 5.
~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Setning 5. (Almenn útgáfa af Setningu 5.7)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. math:: \frac{\partial^4 w}{\partial x^2\partial y \partial z} = \frac{\partial^4 w}{\partial x \partial y \partial x \partial z}
...
Setning 6. (Keðjureglan í einni breytistærð.)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. math:: g'(t)=f_1(x(t),y(t))x'(t)+f_2(x(t),y(t))y'(t).
...
.. math:: g(s,t)=f(x(s,t),y(s,t)).

Þá gildir (að gefnum sambærilegum skilyrðum og í 6.2) að

.. math:: g_1(s,t)=f_1(x(s,t),y(s,t))x_1(s,t)+f_2(x(s,t),y(s,t))y_1(s,t),

 og

.. math:: g_2(s,t)=f_1(x(s,t),y(s,t))x_2(s,t)+f_2(x(s,t),y(s,t))y_2(s,t).
...
.. math:: f(tx_1, tx_2, \ldots, tx_n)=t^kf(x_1, x_2, \ldots, x_n).
...
.. math:: \sum_{i=1}^n x_if_i(x_1, x_2, \ldots, x_n)=kf(x_1, x_2, \ldots, x_n).
...
.. math:: \lim_{h\rightarrow 0}\frac{f(a+h)-L(a+h)}{h}=0.
...
Setning 7. (Meðalgildissetningin)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. math:: f(a+h,b+k)-f(a,b)=hf_1(a+\theta_1h,b+k)+kf_2(a,b+\theta_2k).
...
.. math:: D(\mbox{${\bf g}$}\circ\mbox{${\bf f}$})(\mbox{${\bf x}$})=D\mbox{${\bf g}$}(\mbox{${\bf f}$}(\mbox{${\bf x}$}))D\mbox{${\bf f}$}(\mbox{${\bf x}$}).
...
.. math:: f_1(a,b)(x-a)+f_2(a,b)(y-b)=0.
...
.. math:: D_{\mbox{${\bf u}$}}f(a,b)=\lim_{h\rightarrow 0^+}\frac{f(a+hu, b+hv)-f(a,b)}{h}
...
.. math:: D_{\mbox{${\bf u}$}}f(a,b)=\mbox{${\bf u}$}\cdot \nabla f(a,b).
...
.. math:: f_1(a,b,c)(x-a)+f_2(a,b,c)(y-b)+f_3(a,b,c)(z-c)=0.
...
.. math:: y'(x_0)=-\frac{F_1(x_0,y_0)}{F_2(x_0,y_0)}.
...
.. math:: \varphi(a_1,\ldots,a_{n-1})=a_n
...
.. math:: \varphi_1(a_1,\ldots,a_m)=b_1,\ldots,\varphi_n(a_1,\ldots,a_m)=b_n \qquad \text{og}
