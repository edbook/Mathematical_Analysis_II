...
project = u'Stærðfræðigreining II (STÆ205G)'
copyright = u'2015, Sigurður Örn Stefánsson'
author = u'Sigurður Örn Stefánsson'
...
latex_documents = [
  (master_doc, 'StaeII.tex', u'Stærðfræðigreining II (STÆ205G)',
   u'Sigurður Örn Stefánsson', 'manual'),
]
